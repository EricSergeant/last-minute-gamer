...
const Main = () => {
  return (
    <div className='main-text'>
      ...
      <p className="main-text">For a more detailed description, grab a copy of the <a href="https://dnd.wizards.com/products/dungeon-masters-guide" target="_blank" rel="noreferrer">Dungeon Master's Guide</a> or check out official information <a href="https://www.dndbeyond.com/sources/basic-rules/monsters#Challenge" target="_blank" rel="noreferrer">from DNDBeyond</a> regarding CR.</p>
    </div>
  )
}
