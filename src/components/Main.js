...
const Main = () => {
  return (
    <div className='main'>
      ...
      <p>For a more detailed description, grab a copy of the <a href="https://dnd.wizards.com/products/dungeon-masters-guide" target="_blank" rel="noreferrer">Dungeon Master's Guide</a></p>
    </div>
  )
}
